...
public class SqLiteSQLWrapper implements SQLWrapper {
	...
	private final String dbName = "toolbox.db";
	private String dbPath = "/Users/gazelle.zaheer/Downloads/sqlite-tools-osx-x86-3240000";
    ...
    private Connection getConnection() throws SQLException {
	    ...
	    //}
		String url = sqLiteInstance.protocol + "/" + sqLiteInstance.dbPath +"/" +sqLiteInstance.dbName;
