...
public class Anatomy extends Anonymizer {		
	 ...
	 */
	protected EquivalenceTable createEquivalenceTable(String tableName) throws Exception {
	 ...
	 */
	protected AnonRecordTable createAnonRecordsTable(String tableName) throws Exception {
	...
	public void anonymize() throws Exception{
		...
		System.out.println("Sensitive attribute count started!");
		...
		System.out.println("Dataset eligibility check for l value started!");
		...
		while(existsLNonEmptyBuckets(sensCounts, conf.l)) {
			...
			System.out.println("Group "+numIterations+" created!");
		}

		System.out.println("Residue assignment started!");
