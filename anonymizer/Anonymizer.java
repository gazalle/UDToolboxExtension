...
public abstract class Anonymizer {
	...
	public DBSelector sel = new DBSelector();
	
	/** Class constructor*/
	public Anonymizer(Configuration conf) throws Exception {
		this.conf = conf;
	}
	 ...
	 */
	protected abstract EquivalenceTable createEquivalenceTable(String tableName) throws Exception;
	 ...
	 * @return The table that was just created
	 */
	protected abstract AnonRecordTable createAnonRecordsTable(String tableName) throws Exception;
